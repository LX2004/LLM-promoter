...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="gemma_output")
    parser.add_argument("--best_lora_name", type=str, default="Best_lora")
    ...
    print("\n" + "=" * 90)
    print("Hyperopt TPE search finished.")
    print("=" * 90)
